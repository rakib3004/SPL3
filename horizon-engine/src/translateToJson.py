...
class InterfaceImplementer implements MyInterface {
    @Override
    public void myMethod() {
        System.out.println("InterfaceImplementer implements MyInterface");
    }
}

class PatternClass1 {
    void patternMethod() {
        System.out.println("PatternClass1 method");
    }
}

class PatternClass2 {
    void patternMethod() {
        System.out.println("PatternClass2 method");
    }
}

class PatternClass3 {
    void patternMethod() {
        System.out.println("PatternClass3 method");
    }
}

class CombinedClass extends PatternClass1 implements MyInterface {
    @Override
    public void myMethod() {
        System.out.println("CombinedClass extends PatternClass1 and implements MyInterface");
    }
}
...
public class Main {
    public static void main(String[] args) {
        ...
        PatternClass1 patternClass1 = new PatternClass1();
        PatternClass2 patternClass2 = new PatternClass2();
        PatternClass3 patternClass3 = new PatternClass3();
        CombinedClass combinedClass = new CombinedClass();

        interfaceImplementer.myMethod();

        patternClass1.patternMethod();
        patternClass2.patternMethod();
        patternClass3.patternMethod();

        combinedClass.patternMethod();
        combinedClass.myMethod();

        InterfaceImplementer interfaceImplementer2 = new InterfaceImplementer();
        PatternClass1 patternClass1Instance2 = new PatternClass1();

        interfaceImplementer2.myMethod();
        patternClass1Instance2.patternMethod();
    }
}
